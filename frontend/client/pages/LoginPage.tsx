    ...
    <div className={"bg-[#F9F9FB] min-h-screen"}>
      ...
      <div className={"flex justify-center mt-45 animate-fadeIn"}>
        <form
          ...
          className={"bg-white shadow-xl rounded-2xl text-2xl p-15"}
        >
          ...
          <div className={"flex justify-center flex-col items-center"}>
            <input
              ...
              {...register("login")}
              className={
                "hover:border-green-600 transition ease block border rounded-xl mt-5 p-2 placeholder:text-xl w-full max-w-xs"
              }
            />
            {errors.login && (
          ...
          <div className={"flex justify-center mt-5"}>
            <button
              ...
              disabled={isLoading}
              className={
                "text-xl w-full max-w-xs p-2 border rounded-2xl bg-green-400 hover:bg-green-500 transition ease-in disabled:bg-gray-400"
              }
            >
