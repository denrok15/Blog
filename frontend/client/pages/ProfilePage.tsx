      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="flex flex-col md:flex-row gap-6">
          <div className="bg-white p-6 rounded-xl shadow-md flex-1">
            <h4 className="text-2xl font-semibold text-gray-800 mb-6 pb-2 border-b border-gray-200">
              Обо мне
            </h4>
          ...
          <div className="bg-white p-6 rounded-xl shadow-md w-full md:w-1/3">
            <div className="flex flex-col space-y-4">
              <button className="px-4 py-3 bg-gray-100 hover:bg-gray-200 rounded-lg text-gray-800 text-left transition-colors">
