    ...
    return (
        <div className={'flex justify-center mt-60'}>
            <form onSubmit={handesubmit} className={'bg-amber-50/60 shadow-xl rounded-2xl text-2xl p-15 '}>
                ...
                <div className={'flex justify-center'}>
                    <button type={'submit'} className={'w-full mt-5 p-2 border rounded-2xl bg-green-400'}>Войти в аккаунт</button>
                </div>


                <p className={'text-center text-lg mt-5'}><a  href="/registr">Нет аккаунта? Зарегестрируйся!</a></p>
