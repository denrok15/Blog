            ...
            <div className={'mt-0 h-full'}>
                ...
                <div className="flex justify-center gap-8 my-10">
                    ...
                    <button onClick={lets_start}
                            className="py-3 mr-6 mt-2 px-8 border rounded-2xl bg-[#3328BF] text-3xl text-white font-semibold hover:bg-[#251D8F] transition">Давай
                        начнем!
                    </button>
                </div>
                ...
                <div className="bg-gradient-to-r from-purple-50 to-blue-50 p-6 rounded-2xl max-w-md mx-auto mt-10">
                    <div className="flex items-center mb-4">
                        ...
                        <div>
                            ...
                            <p className="ml-2 text-yellow-600 font-semibold">Топ-комментатор недели</p>
                        </div>
                    </div>
